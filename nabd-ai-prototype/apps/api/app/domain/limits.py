...
LIMIT_REGISTER: Final[tuple[Limit, ...]] = (
    Limit("question_length_chars", QUESTION_MAX_CHARS, "characters", ReasonCode.REQUEST_LIMIT_EXCEEDED),
    Limit("sources_in_plan", SOURCE_PLAN_MAX, "sources", ReasonCode.SOURCE_LIMIT_EXCEEDED),
    Limit("retrieval_candidates", RETRIEVAL_CANDIDATE_MAX, "candidates", ReasonCode.RETRIEVAL_LIMIT_EXCEEDED),
    ...
    Limit("total_evidence_context_chars", TOTAL_EVIDENCE_CONTEXT_MAX_CHARS, "characters", ReasonCode.CONTEXT_LIMIT_EXCEEDED),
    Limit("model_calls", MODEL_CALLS_MAX, "calls", ReasonCode.MODEL_CALL_LIMIT_EXCEEDED),
    Limit("same_endpoint_retries", SAME_ENDPOINT_RETRY_MAX, "retries", ReasonCode.RETRY_LIMIT_EXCEEDED),
    Limit("model_output_chars", MODEL_OUTPUT_MAX_CHARS, "characters", ReasonCode.MODEL_OUTPUT_LIMIT_EXCEEDED),
    Limit("case_wall_clock_seconds", CASE_WALL_CLOCK_SECONDS, "seconds", ReasonCode.CASE_WALL_CLOCK_LIMIT_EXCEEDED),
    Limit("concurrent_cases", CONCURRENT_CASES_MAX, "cases", ReasonCode.CONCURRENCY_LIMIT_EXCEEDED),
    Limit("packet_export_interval_seconds", PACKET_EXPORT_MIN_INTERVAL_SECONDS, "seconds", ReasonCode.EXPORT_RATE_LIMIT_EXCEEDED),
)
